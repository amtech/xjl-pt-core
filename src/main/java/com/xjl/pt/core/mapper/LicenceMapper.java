...
public interface LicenceMapper {
	 ...
	 * @param domain
	 */
	@Update("update "+TABLE_NAME+" set licence_name =#{licenceName},issuing_date=#{issuingDate},expiration_date=#{expirationDate},licence_file_url=#{licenceFileUrl},licence_file_type=#{licenceFileType},licence_status=#{licenceStatus},licence_category=#{licenceCategory} where licence_id =#{licenceId}")
