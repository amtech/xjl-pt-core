...
public interface DictValueMapper {
	...
	@Insert("insert into " + TABLE_NAME + "(dict_id,dict_value_code,dict_value_name," + XJLMapper.FIX_INSERT_FIELD + ")"
			+ " values(#{dictId},#{dictValueCode},#{dictValueName}," + XJLMapper.FIX_INSERT_VALUE+")")
	public void insert(XJLDomain domain);
	@Select("select dict_id as dictId, dict_value_code as dictValueCode,dict_value_name as dictValueName, "
